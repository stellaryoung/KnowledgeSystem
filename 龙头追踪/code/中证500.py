...
if __name__ == "__main__":
    ...
    for i in range(1, 14):
        ...
        url = 'http://vip.stock.finance.sina.com.cn/corp/view/vII_NewestComponent.php?page={}&indexid=000905'.format(str(i))
        print(url)
    ...
    res = '\n'.join(res)
    with open('../raw/中证500.txt', 'w', encoding='utf-8') as f:
        f.write(res)
